...
import ru.itis.summerpractise24_1.databinding.FragmentDerezzedBinding

class DerezzedFragment : Fragment(R.layout.fragment_derezzed) {
    private lateinit var binding: FragmentDerezzedBinding
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        binding = FragmentDerezzedBinding.bind(view)
