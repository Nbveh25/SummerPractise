...
import ru.itis.summerpractise24_1.databinding.FragmentCheriCheriLadyBinding
import ru.itis.summerpractise24_1.databinding.FragmentStopBinding

class CheriCheriLadyFragment : Fragment(R.layout.fragment_cheri_cheri_lady) {
    private lateinit var binding: FragmentCheriCheriLadyBinding
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        binding = FragmentCheriCheriLadyBinding.bind(view)
