...
import ru.itis.summerpractise24_1.databinding.FragmentZittieBuoniBinding

class ZittieBuoniFragment : Fragment(R.layout.fragment_zittie_buoni) {
    private lateinit var binding: FragmentZittieBuoniBinding
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        binding = FragmentZittieBuoniBinding.bind(view)
